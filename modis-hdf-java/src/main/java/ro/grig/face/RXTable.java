...
public class RXTable extends JTable {
    ...
    * 
    */
   private static final long serialVersionUID = 4761643616918731201L;
   ...
   /**
    * Constructs a <code>RXTable</code> that is initialized with <code>dm</code>
    ...
    * column names, <code>columnNames</code>. The <code>Vectors</code> contained
    * in <code>rowData</code> should contain the values for that row. In other
    ...
    * <code>columnNames</code>. <code>rowData</code> is an array of rows, so the
    * value of the cell at row 1, column 5 can be obtained with the following
    * code:
    * <p>
    * 
    * <pre>
    ...
    * @param columnNames
    *           an array containing the column names in the order they should be
    *           displayed
    */
   ...
   static class DoubleCellRenderer extends NumberCellRenderer {
   ...
   public TableCellRenderer getCellRenderer(int row, int column) {
      Class<?> colCl = getModel().getColumnClass(column);
      if (colCl == Double.class) {
