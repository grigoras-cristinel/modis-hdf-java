...
/**
 * Trimite mesajele din client catre server. Nu are nevoie de raspuns
 * 
 * @author grig
 *
 */
public class InterprocessClient implements Runnable {
   ...
   public InterprocessClient(InetAddress hostAddress, int port) throws IOException {
