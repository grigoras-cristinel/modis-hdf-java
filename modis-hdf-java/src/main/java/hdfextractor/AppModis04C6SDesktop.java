 ...
 * date si le pune in folderul out pentru fiecare statie. Dar nu e in cluster.
 *
 * @author Grigoras Cristinel
 *
 *
 */
public class AppModis04C6SDesktop extends RunProcessAbstractSupport {

   /**
    * Logger for this class
    */
   private static final Logger logger = LoggerFactory.getLogger(AppModis04C6SDesktop.class);
   ...
   public static void main(String[] args) throws FileNotFoundException {
      logger.debug("Start " + args.toString());
      AppModis04C6SDesktop runn = new AppModis04C6SDesktop();
      runn.initComunication();
