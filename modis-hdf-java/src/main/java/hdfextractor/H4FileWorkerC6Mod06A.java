...
/**
 * Parseaza un fiser HDF pentru modis06 colectia C6
 * 
 * @author Grigoras Cristinel
 * 
 */
public class H4FileWorkerC6Mod06A implements Serializable {
   ...
   public H4FileWorkerC6Mod06A(H4File h4file) throws Exception {
      super();
      this.file = h4file;
      file.open();
   }

   public H4FileWorkerC6Mod06A(String h4fileLocation) throws Exception {
      file = new H4File(h4fileLocation, FileFormat.READ);
      file.open();
   }

   public H4FileWorkerC6Mod06A(String canonicalPath, TreeMap<String, double[]> statii) throws Exception {
      this(canonicalPath);
      puncte = statii;
      parseFile();
   }
