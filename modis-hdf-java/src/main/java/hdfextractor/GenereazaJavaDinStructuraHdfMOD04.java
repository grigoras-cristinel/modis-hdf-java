...
public class GenereazaJavaDinStructuraHdfMOD04 {
   /**
	 *
	 */
   TreeSet<ObiectDesc> gasite = new TreeSet<GenereazaJavaDinStructuraHdfMOD04.ObiectDesc>(
         new Comparator<GenereazaJavaDinStructuraHdfMOD04.ObiectDesc>() {
            @Override
   ...
   class ObiectDesc implements Comparable<ObiectDesc> {
      ...
      public String javaNumeCamp() {
         ...
         fnup = StringUtils.replace(fnup, "_", " ").replace('.', 'p');
      ...
      public String buildConstantName() {
         return numeCamp.toUpperCase().replace(".", "p");
      }
   }
   ...
   public static void main(String[] args) {
      ...
      GenereazaJavaDinStructuraHdfMOD04 clasamea = new GenereazaJavaDinStructuraHdfMOD04();
   ...
   private void buildJavaClass(TreeSet<ObiectDesc> gasite) throws Exception {
      ...
      hdfconstants.setPackage("hdfextractor").setName("Mod04C6Constants");
      hdfconstants.addInterface(Serializable.class);
      ArrayList<String> fn = new ArrayList<String>();
      for (ObiectDesc field : gasite) {
         String fnup = field.buildConstantName();
      ...
      String workerClassName = "H4FileWorkerC6Mod04";
      ...
      body.append("System.out.println(\"parseFile()\");\r\n"
            ...
            + "      int cellAlong500 = dims.get(\"Cell_Along_Swath_500\");     H4Group testGroup = (H4Group) file.get(\"/"
            + "mod04" + "/Geolocation Fields\");\r\n"
            ...
            + "            }         }      }\r\n" + "      H4Group dataFieldsGrup = (H4Group) file.get(\"/" + "mod04"
            + "/Data Fields\");\r\n"
      ...
      for (ObiectDesc field : gasite) {
         ...
         String constN = field.buildConstantName();
         ...
         if (field.dimSize == 2) {
            ...
            if (field.cellSize == 1) {
               unfs.append("valoare.set");
               unfs.append(fnuac);
               unfs.append("(wrap.findDoublePozitionData(pozSearch500));");
            }
         }
         if (field.dimSize == 3) {
         }
   ...
   private void buildJavaClassMODTO(TreeSet<ObiectDesc> gasite, JavaClassSource modto) {
      modto.setPackage("hdfextractor").setName("Mod04C06TO");
      ...
      modto.addProperty(Long.class, "pozitie").getField().getJavaDoc().setText("Pozitia corespunzatoare pt 10 km");
      modto.addProperty(Long.class, "pozitieAcross").getField().getJavaDoc()
            .setText("Pozitia corespunzatoare pt 10 km perpendicular pe directie");
      modto.addProperty(Long.class, "pozitieAlong").getField().getJavaDoc()
            .setText("Pozitia corespunzatoare pt 500 km pe directie");
      modto.addProperty(Long.class, "pozitie500").getField().getJavaDoc().setText("Pozitia corespunzatoare pt 500 m");
      modto.addProperty(Double.class, "deltaPozitieM").getField().getJavaDoc()
            .setText("Distanta dintre punctul pe grila de 10km si cel pe grila de 500m");
      ...
      metexpbody.append("      SimpleStringLineBuilder builder = new SimpleStringLineBuilder();\r\n"
            + "      DateTime timp2 = timp.withZone(DateTimeZone.UTC);\r\n"// split
   ...
   protected void findFieldsFromHdfFile() throws Exception {
      String hdffile = "t:/data/MOD06MYD06_C6/MYD04_L2.A2003327.1045.006.2014010212202.hdf";
      ...
      while (itDataFields.hasNext()) {
         ...
         if (hObject instanceof H4SDS) {
            ...
            if (NumberUtils.max(dims) == dimensiuni.get("Cell_Along_Swath")) {
               struct.cellSize = 5;
            }
            if (NumberUtils.max(dims) == dimensiuni.get("Cell_Along_Swath_500")) {
               struct.cellSize = 1;
            }
