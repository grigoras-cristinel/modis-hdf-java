 ...
 * 
 */
public class ComparaExcellCuSatelitMedieLunara {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		System.out.println("Start");
		ComparaExcellCuSatelitMedieLunara worker = new ComparaExcellCuSatelitMedieLunara();
		worker.execute();
	...
	private void execute() {
		...
		for (Entry<String, double[]> statie : StatiiMeteoBucuresti.statii
			...
			String combinedIn = "target/combined-statie-" + statie.getKey()
					+ ".txt";
			String combinedOut = "target/comparare-lunara-" + statie.getKey() + ".txt";
